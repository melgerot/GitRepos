...
namespace SAP.CRM.Core.SAL
{
    ...
    {
        #region Get Sales Activities from SAP
        ...
        public List<IBusinessEntity> BusinessEntityList { get; set; }

        public ServiceHelper()
        {
            BusinessEntityList = new List<IBusinessEntity>();
        }
                ...
                client.DownloadStringCompleted += (sender, e) =>
                {
                    try
                    {
                        ...
                        foreach (var a in response.ActivityGeneralData)
                        {
                            ...
                            BusinessEntityList.Add(activity);
                        }              
                    }
                    catch (Exception ex)
                    {
        ...
        //void GetSalesActivities_Completed(object sender, DownloadStringCompletedEventArgs e)
        //{
        //    if (e.Error != null)
        //    {
        //        if (OnGetSalesActivitiesFailed != null)
        //            OnGetSalesActivitiesFailed();
        //    }
        //    else
        //    {
        //        var json = e.Result;
        ...
        //        if (OnGetSalesActivitiesCompleted != null)
        //            OnGetSalesActivitiesCompleted();
        //    }
        //}
