...
namespace Sample
{
	public partial class SampleViewController : UIViewController
	{
		private static readonly MobileServiceClient MobileService =
			new MobileServiceClient ("https://enfosigndemo1.azure-mobile.net", "FelWoLbbJJbPAbSGPpaMyZMhAoBtzH19");
		...
		public override void ViewDidAppear (bool animated)
		{
			...
			UIViewController loginViewController = new UIViewController();
			MobileService.LoginAsync(loginViewController, MobileServiceAuthenticationProvider.MicrosoftAccount);
			this.PresentViewController(loginViewController,true, Logon_Completed);
